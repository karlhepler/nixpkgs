...
The same discipline applies to derived per-unit rates. State what the denominator actually includes. If a large fraction of the denominator is idle or dormant time rather than active work, the rate understates intensity by roughly that fraction — report the active-period rate alongside the diluted one so a reader isn't misled about what's actually being measured.
