...
**Currently no browser-automation tool installed.** When visual inspection of rendered pages would help, flag the limitation and describe what should be seen. (pnpm snap / Playwright / Chrome DevTools MCP — candidate tooling under evaluation.)
