...
**The core rule is § Hard Rules item 6.** This section extends it with the deepest failure mode and eight concrete trigger scenarios for WHEN the rule fires.
...
**Eight trigger scenarios — when the rule fires:**
