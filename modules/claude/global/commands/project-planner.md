...
5. **Mark work complete and wait for coordination:**
   ...
   The staff engineer or coordinator will:
...
## GOAL
Developers waste 3 hours daily on slow tests and flaky failures. This blocks feature shipping. Users wait for important features while devs debug false alarms. **Unblock developers so they can ship features 50% faster and users get what they need in half the time.**
...
## ASSUMPTIONS
| Assumption | Risk | Monitor |
|------------|------|---------|
| Developers adopt local workflow | Medium | Weekly CI usage, monthly survey |
...
4. End of Project Status Report (validate success measures, lessons learned)

## CAUSAL CHECK
✓ YES - Deliverables + assumptions → objective → goal. Success measures verify goal achievement.
...
- All success measures track goal (outcomes), not objective (outputs)
...
**DO NOT:**
- Mark your own card done (coordinator does this after verification)
- Skip documentation (coordinator needs context for handoff)
