...
#
# Effort is pinned to `xhigh` per D14's step-up clause for "demanding coding
# and agentic work" (docs/v5-migration/A-anthropic-v5-guidance.md:492) — this
# coordinator session qualifies under that clause. D16 separately calls for
# a fresh effort sweep rather than carrying settings over; that sweep was
# not run here — this is a stated rationale, not an empirical result. See
