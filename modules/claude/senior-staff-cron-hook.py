...
_CRON_PROMPT = (
    ...
    "  If the only pane listed is your own (the senior-staff window), stop immediately — no output, no crew status, no report. Token waste avoided.\n"
    ...
    "  If `crew find` returns no matches across all panes, all panes are idle — stop immediately. No crew status, no report. Token waste avoided.\n"
